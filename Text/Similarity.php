...
class Similarity {
    private array $excludeTr = ['VE', 'DA', 'DE', 'MI', 'MU', 'MÜ', 'AMA', 'İLE', 'BİR', 'BU', 'ŞU', 'O'];
    private array $excludeEn = ['AND', 'THE', 'IS', 'ARE', 'A', 'AN', 'IN', 'ON', 'OF', 'TO', 'FOR', 'WITH', 'AT', 'BY'];
    private array $excludeCustom = [];
    private array $words = [];
    private array $source = [];
    private array $target = [];
    private float $cosine = 0.6;
    private float $similar = 0.3;
    private float $levenshtein = 0.1;
